...
feature -- Access.
	...
	is_obstacle_mostly_at_left: BOOLEAN
		...
		is_real_obstacle_in_front:BOOLEAN
	do
		Result := (sensors[1].is_valid_range and sensors[2].is_valid_range and sensors[3].is_valid_range ) or  (sensors[3].is_valid_range and sensors[4].is_valid_range and sensors[5].is_valid_range)
	end
	...
	no_obstacle_on_left:BOOLEAN
	do
		Result := not (sensors[1].is_valid_range and sensors[2].is_valid_range and sensors[3].is_valid_range)
	end

	no_obstacle_on_right:BOOLEAN
	do
		Result := not (sensors[3].is_valid_range and sensors[4].is_valid_range and sensors[5].is_valid_range)
	end
